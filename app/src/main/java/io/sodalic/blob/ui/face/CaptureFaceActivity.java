package io.sodalic.blob.ui.face;
 ...
 * for further processing via {@link FaceSightcorpApi}
 * <p>
...
public class CaptureFaceActivity extends BlobActivity {
    ...
    private boolean preferFrontFacing = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnTake = findViewById(R.id.submitButton);
        ...
        btnSwitchCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i(TAG, "Switching orientation to front = " + preferFrontFacing);
    ...
    // Methods to help integrating Fragment-based code into an Activity
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 2 || grantResults[0] != PackageManager.PERMISSION_GRANTED || grantResults[1] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(getString(R.string.permission_failure_message))
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        Objects.requireNonNull(manager, "CameraManager");
        try {
            String[] cameraIdList = manager.getCameraIdList();
            final boolean hasSeveral = cameraIdList.length > 1;
            Log.i(TAG, "All cameras are " + Arrays.toString(cameraIdList));
            btnSwitchCamera.setVisibility(hasSeveral ? View.VISIBLE : View.GONE);
            ...
            for (String cameraId : cameraIdList) {
                ...
                if ((facing != null) && hasSeveral &&
                        ((preferFrontFacing && facing == CameraCharacteristics.LENS_FACING_BACK)
                                || (!preferFrontFacing && facing == CameraCharacteristics.LENS_FACING_FRONT))) {
                    continue;
                }

                if (configureForCamera(cameraId, width, height, characteristics)) {
                    mCameraId = cameraId;
                    return;
                }
            }
...
//            ErrorDialog.newInstance(getString(R.string.camera_error))
    ...
    private boolean configureForCamera(String cameraId, int width, int height, CameraCharacteristics characteristics) {
        ...
        Log.i(TAG, Arrays.toString(map.getOutputSizes(ImageFormat.JPEG)));
        ...
        Log.i(TAG, StringUtils.formatEn("Preview image size is %s", mPreviewSize));
    ...
    private void captureStillPicture() {
        try {
            ...
            int jpegOrientation = getOrientation(displayRotation);
            Log.i(TAG, StringUtils.formatEn("display rot = %d, jpeg = %d, sensor = %d", displayRotation, jpegOrientation, mSensorOrientation));
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback = new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    unlockFocus();
                    new SendImageForProcessing(CaptureFaceActivity.this, mFile).execute();
                }
            };
    ...
    static class SendImageForProcessing extends HttpUIAsync<FaceSightcorpApi.PersonFaceData> {
        private final File imageFile;

        SendImageForProcessing(BlobActivity activity, File imageFile) {
            super(activity, "Image processing");
